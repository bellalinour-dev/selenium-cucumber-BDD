 ...
 *
 * <p>This class is used to configure and launch Cucumber tests
 * using JUnit as the test execution framework.</p>
 *
 * <p>It defines:
 * <ul>
 ...
 * </p>
 *
 * <p>This runner executes only scenarios tagged with {@code @Create_Ticket}.</p>
 */
...
@CucumberOptions(
        ...
        /**
         * Plugins used to generate test execution reports.
